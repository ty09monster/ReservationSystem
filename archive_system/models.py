...
class Reservation(db.Model):
    ...
    archive_name = db.Column(db.String(200), comment='专业')
    archive_number = db.Column(db.String(100), comment='年级')
    archive_purpose = db.Column(db.Text, comment='查询内容')
    education_level = db.Column(db.String(50), comment='查询学历类别：专科/本科/实用人才/继续教育/研究生')
    ...
    group_name = db.Column(db.String(200), comment='预约人单位')
    group_contact = db.Column(db.String(100), comment='单位联系人')
    id_number = db.Column(db.String(30), comment='预约人身份证号')
